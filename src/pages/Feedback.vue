...
const onErrorSave = () => {
  applicationStore
      .getAlert('error')
      ?.setSettings({message: 'Произошла ошибка при отправке данных'})
      .onShow()
}
    ...
    <section class="page-center container">
      <article class="feedback">
        <div class="feedback-title">
          <h2 class="title">{{
              typeClient === 'new' ? 'Приветствуем новых клиентов!' : 'Мы ценим наших клиентов! И благодарим за ваш выбор'
            }}</h2>
        ...
        <div class="feedback-qrcode">
          ...
          <img v-if="typeClient === 'old'" src="/images/qrcode-old.png" alt="">
        </div>
        <div class="feedback-message">
          <p>Чтобы получить еще больше возможностей для развития вашего бизнеса, позвольте нам с вами связаться.</p>
        </div>
